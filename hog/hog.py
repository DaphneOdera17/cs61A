...
def boar_brawl(player_score, opponent_score):
    ...
    if opponent_score >= 10:
        x = opponent_score // 10 % 10
    else:
        x = 0
    y = player_score % 10
    score = max(1, 3 * abs(x - y))
    return score
    # END PROBLEM 2
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    if abs(sus_update(0, score, opponent_score) - score) >= threshold:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
